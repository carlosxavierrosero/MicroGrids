  ...
  if (nrhs>2 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"library")) {
      ...
      if (!strcmp(machineName,"experiment_lib2")) {
        if (nrhs==3) {
          ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3233434726U);
          ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1150215729U);
          ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2570517920U);
          ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(683246360U);
        } else if (nrhs==4) {
  ...
  int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 7:
      {
        if (strcmp(aiChksum, "k6jXuxo4rHvbvnmPdPTqiH") == 0) {
     ...
     case 9:
      {
        if (strcmp(aiChksum, "Y6Ano0DnyZqJtVNVZCnXyC") == 0) {
     ...
     case 10:
      {
        if (strcmp(aiChksum, "o5SODSVcntFY20iKvgSV1F") == 0) {
     ...
     case 11:
      {
        if (strcmp(aiChksum, "820kty3meMMcPageiDo5BB") == 0) {
  ...
  int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 7:
      {
        if (strcmp(tpChksum, "EwUZdcYHvlbu5GA56KMqj") == 0) {
     ...
     case 9:
      {
        if (strcmp(tpChksum, "EiFR3Gor2dBm3B1msKPlL") == 0) {
     ...
     case 10:
      {
        if (strcmp(tpChksum, "BoY0OilOfPF8xEph9x5zxB") == 0) {
     ...
     case 11:
      {
        if (strcmp(tpChksum, "yP8D28dRBUH0ZNfxqEnb4B") == 0) {
