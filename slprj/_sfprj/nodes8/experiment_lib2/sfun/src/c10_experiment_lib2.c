  ...
  (SFc10_experiment_lib2InstanceStruct *chartInstance)
{
  ...
  real_T (*c10_out)[8];
  c10_out = (real_T (*)[8])ssGetOutputPortSignal(chartInstance->S, 1);
  c10_st = NULL;
  c10_st = NULL;
  c10_y = NULL;
  sf_mex_assign(&c10_y, sf_mex_createcellmatrix(2, 1), false);
  for (c10_i0 = 0; c10_i0 < 8; c10_i0++) {
    c10_u[c10_i0] = (*c10_out)[c10_i0];
  }

  c10_b_y = NULL;
  sf_mex_assign(&c10_b_y, sf_mex_create("y", c10_u, 0, 0U, 1U, 0U, 1, 8), false);
  ...
  *chartInstance)
{
  ...
  c10_b_out = (real_T (*)[8])ssGetOutputPortSignal(chartInstance->S, 1);
  c10_b_V = (real_T (*)[8])ssGetInputPortSignal(chartInstance->S, 0);
  ...
  c10_out[_SFD_EML_ARRAY_BOUNDS_CHECK("out", (int32_T)_SFD_INTEGER_CHECK("a",
    c10_b_a), 1, 8, 1, 0) - 1] = c10_val;
  _SFD_EML_CALL(0U, chartInstance->c10_sfEvent, -3);
  _SFD_SYMBOL_SCOPE_POP();
  for (c10_i5 = 0; c10_i5 < 8; c10_i5++) {
  ...
  *c10_inData)
{
  ...
  for (c10_i7 = 0; c10_i7 < 8; c10_i7++) {
    c10_b_inData[c10_i7] = (*(real_T (*)[8])c10_inData)[c10_i7];
  }

  for (c10_i8 = 0; c10_i8 < 8; c10_i8++) {
    c10_u[c10_i8] = c10_b_inData[c10_i8];
  }

  c10_y = NULL;
  sf_mex_assign(&c10_y, sf_mex_create("y", c10_u, 0, 0U, 1U, 0U, 1, 8), false);
  ...
  real_T c10_y[8])
{
  ...
  int32_T c10_i9;
  (void)chartInstance;
  sf_mex_import(c10_parentId, sf_mex_dup(c10_u), c10_dv1, 1, 0, 0U, 1, 0U, 1, 8);
  for (c10_i9 = 0; c10_i9 < 8; c10_i9++) {
  ...
  *c10_mxArrayInData, const char_T *c10_varName, void *c10_outData)
{
  ...
  c10_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c10_out), &c10_thisId, c10_y);
  sf_mex_destroy(&c10_out);
  for (c10_i10 = 0; c10_i10 < 8; c10_i10++) {
    (*(real_T (*)[8])c10_outData)[c10_i10] = c10_y[c10_i10];
  }
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1189213702U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2131842193U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1427876516U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3577928417U);
}
...
mxArray *sf_c10_experiment_lib2_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("N5f8ydqTBjycaUBSmQDkh");
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
...

        {
          ...
          c10_out = (real_T (*)[8])ssGetOutputPortSignal(chartInstance->S, 1);
          c10_V = (real_T (*)[8])ssGetInputPortSignal(chartInstance->S, 0);
...
static void mdlSetWorkWidths_c10_experiment_lib2(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(1483766052U));
  ssSetChecksum1(S,(3058048148U));
  ssSetChecksum2(S,(4189739059U));
  ssSetChecksum3(S,(4171299193U));
