  ...
  if (nrhs>2 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"library")) {
      ...
      if (!strcmp(machineName,"experiment_lib2")) {
        if (nrhs==3) {
          ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1765284923U);
          ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2285098626U);
          ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1414040404U);
          ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1451210834U);
        } else if (nrhs==4) {
  ...
  int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 7:
      {
        if (strcmp(aiChksum, "kuDbDhrgsYypaCtQ6mloFC") == 0) {
     ...
     case 9:
      {
        if (strcmp(aiChksum, "TLsw84J0KjNxdjizWg1ZTG") == 0) {
     ...
     case 10:
      {
        if (strcmp(aiChksum, "N5f8ydqTBjycaUBSmQDkh") == 0) {
     ...
     case 11:
      {
        if (strcmp(aiChksum, "Ef3GWqhnWCL7RDNkepqFnE") == 0) {
  ...
  int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 7:
      {
        if (strcmp(tpChksum, "1BZ62ycpklcJZntd4ny93D") == 0) {
     ...
     case 9:
      {
        if (strcmp(tpChksum, "4FDgjPLs3APmwb4uqW2kSC") == 0) {
     ...
     case 10:
      {
        if (strcmp(tpChksum, "xJQAIjAfbXf0jlm1y5MiXC") == 0) {
     ...
     case 11:
      {
        if (strcmp(tpChksum, "p2GURsWEDczUqEnhsLk0sH") == 0) {
  ...
  debugInstance)
{
  _experiment_lib2MachineNumber_ = sf_debug_initialize_machine(debugInstance,
    "experiment_lib2","sfun",1,5,0,0,0);
