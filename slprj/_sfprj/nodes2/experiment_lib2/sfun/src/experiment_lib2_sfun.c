  ...
  if (nrhs>2 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"library")) {
      ...
      if (!strcmp(machineName,"experiment_lib2")) {
        if (nrhs==3) {
          ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2117938397U);
          ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3956274874U);
          ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(808076115U);
          ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(271003405U);
        } else if (nrhs==4) {
