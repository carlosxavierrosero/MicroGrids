  ...
  (SFc9_experiment_lib2InstanceStruct *chartInstance)
{
  ...
  real_T (*c9_out)[32];
  c9_out = (real_T (*)[32])ssGetOutputPortSignal(chartInstance->S, 1);
  c9_st = NULL;
  c9_st = NULL;
  c9_y = NULL;
  ...
  c9_b_y = NULL;
  sf_mex_assign(&c9_b_y, sf_mex_create("y", c9_u, 0, 0U, 1U, 0U, 1, 32), false);
  ...
  *chartInstance)
{
  ...
  c9_b_out = (real_T (*)[32])ssGetOutputPortSignal(chartInstance->S, 1);
  c9_b_Q = (real_T (*)[32])ssGetInputPortSignal(chartInstance->S, 0);
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2908617494U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(41772855U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(96675589U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2223854601U);
}
...
mxArray *sf_c9_experiment_lib2_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("R6lqvZmTc3oUdXkRe2zQL");
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
...

        {
          ...
          c9_out = (real_T (*)[32])ssGetOutputPortSignal(chartInstance->S, 1);
          c9_Q = (real_T (*)[32])ssGetInputPortSignal(chartInstance->S, 0);
...
static void mdlSetWorkWidths_c9_experiment_lib2(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(1015932100U));
  ssSetChecksum1(S,(3934049976U));
  ssSetChecksum2(S,(507365118U));
  ssSetChecksum3(S,(877416438U));
