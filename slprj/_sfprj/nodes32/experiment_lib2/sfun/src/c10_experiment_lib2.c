  ...
  (SFc10_experiment_lib2InstanceStruct *chartInstance)
{
  ...
  real_T (*c10_out)[32];
  c10_out = (real_T (*)[32])ssGetOutputPortSignal(chartInstance->S, 1);
  c10_st = NULL;
  c10_st = NULL;
  c10_y = NULL;
  sf_mex_assign(&c10_y, sf_mex_createcellmatrix(2, 1), false);
  for (c10_i0 = 0; c10_i0 < 32; c10_i0++) {
    c10_u[c10_i0] = (*c10_out)[c10_i0];
  }

  c10_b_y = NULL;
  sf_mex_assign(&c10_b_y, sf_mex_create("y", c10_u, 0, 0U, 1U, 0U, 1, 32), false);
  ...
  *chartInstance)
{
  ...
  c10_b_out = (real_T (*)[32])ssGetOutputPortSignal(chartInstance->S, 1);
  c10_b_V = (real_T (*)[32])ssGetInputPortSignal(chartInstance->S, 0);
  _SFD_SYMBOL_SCOPE_PUSH(0U, 0U);
  _sfTime_ = sf_get_time(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 2U, chartInstance->c10_sfEvent);
  for (c10_i2 = 0; c10_i2 < 32; c10_i2++) {
  ...
  c10_out[_SFD_EML_ARRAY_BOUNDS_CHECK("out", (int32_T)_SFD_INTEGER_CHECK("a",
    c10_b_a), 1, 32, 1, 0) - 1] = c10_val;
  _SFD_EML_CALL(0U, chartInstance->c10_sfEvent, -3);
  _SFD_SYMBOL_SCOPE_POP();
  for (c10_i5 = 0; c10_i5 < 32; c10_i5++) {
  ...
  *c10_inData)
{
  ...
  for (c10_i7 = 0; c10_i7 < 32; c10_i7++) {
    c10_b_inData[c10_i7] = (*(real_T (*)[32])c10_inData)[c10_i7];
  }

  for (c10_i8 = 0; c10_i8 < 32; c10_i8++) {
    c10_u[c10_i8] = c10_b_inData[c10_i8];
  }

  c10_y = NULL;
  sf_mex_assign(&c10_y, sf_mex_create("y", c10_u, 0, 0U, 1U, 0U, 1, 32), false);
  ...
  real_T c10_y[32])
{
  ...
  int32_T c10_i9;
  (void)chartInstance;
  sf_mex_import(c10_parentId, sf_mex_dup(c10_u), c10_dv1, 1, 0, 0U, 1, 0U, 1, 32);
  for (c10_i9 = 0; c10_i9 < 32; c10_i9++) {
  ...
  *c10_mxArrayInData, const char_T *c10_varName, void *c10_outData)
{
  ...
  c10_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c10_out), &c10_thisId, c10_y);
  sf_mex_destroy(&c10_out);
  for (c10_i10 = 0; c10_i10 < 32; c10_i10++) {
    (*(real_T (*)[32])c10_outData)[c10_i10] = c10_y[c10_i10];
  }
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(523557064U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2417239767U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3368012727U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2530076687U);
}
...
mxArray *sf_c10_experiment_lib2_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("zty55ewFhQHziHSzUPbO9");
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
...

        {
          ...
          c10_out = (real_T (*)[32])ssGetOutputPortSignal(chartInstance->S, 1);
          c10_V = (real_T (*)[32])ssGetInputPortSignal(chartInstance->S, 0);
...
static void mdlSetWorkWidths_c10_experiment_lib2(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(3546555184U));
  ssSetChecksum1(S,(2549118559U));
  ssSetChecksum2(S,(428825736U));
  ssSetChecksum3(S,(59594238U));
