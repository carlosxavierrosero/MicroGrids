  ...
  if (nrhs>2 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"library")) {
      ...
      if (!strcmp(machineName,"experiment_lib2")) {
        if (nrhs==3) {
          ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(498124256U);
          ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3318706318U);
          ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2611967641U);
          ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3581040768U);
        } else if (nrhs==4) {
  ...
  int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 7:
      {
        if (strcmp(aiChksum, "NBGvhs3pEk8wJiOVUl7ovG") == 0) {
     ...
     case 9:
      {
        if (strcmp(aiChksum, "R6lqvZmTc3oUdXkRe2zQL") == 0) {
     ...
     case 10:
      {
        if (strcmp(aiChksum, "zty55ewFhQHziHSzUPbO9") == 0) {
     ...
     case 11:
      {
        if (strcmp(aiChksum, "y9ebHDTLBJEYxlgc1fs0fG") == 0) {
  ...
  int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 7:
      {
        if (strcmp(tpChksum, "gU88DkUi99Q0P0BlxX1kBC") == 0) {
     ...
     case 9:
      {
        if (strcmp(tpChksum, "jeBx3mi5pPKOvoIzz7YhlD") == 0) {
     ...
     case 10:
      {
        if (strcmp(tpChksum, "xFJggYh7OlRA5wYVeztReF") == 0) {
     ...
     case 11:
      {
        if (strcmp(tpChksum, "DDXvSL1nOkaScEQxiYGihD") == 0) {
