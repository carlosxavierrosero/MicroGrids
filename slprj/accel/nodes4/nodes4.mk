...
MODEL              = nodes4
MODULES            = nodes4_acc_data.cpp rtGetInf.cpp rtGetNaN.cpp rt_nonfinite.cpp 
MAKEFILE           = nodes4.mk
MATLAB_ROOT        = /Applications/MATLAB_R2014a.app
ALT_MATLAB_ROOT    = /Applications/MATLAB_R2014a.app
MASTER_ANCHOR_DIR  = 
START_DIR          = /Users/carlosxavierroserochandi/Desktop/paperICIEA/conKernel_modified
S_FUNCTIONS        = sf_sfun.c ttkernelMATLAB.cpp ttnetwork.cpp
S_FUNCTIONS_LIB    = 
SOLVER             = 
NUMST              = 3
TID01EQ            = 0
...
ADD_INCLUDES = \
	-I$(START_DIR)/slprj/accel/nodes4 \
	-I$(START_DIR) \
	-I/Users/carlosxavierroserochandi/Documents/truetime-2.0-beta10.1/kernel \
...
%.o : $(MATLAB_ROOT)/simulink/src/%.c
	$(CC) -c $(MEX_FLAGS) $(INCLUDES) "$<"
%.o : /Users/carlosxavierroserochandi/Documents/truetime-2.0-beta10.1/kernel/%.c
	$(CC) -c $(MEX_FLAGS) $(INCLUDES) "$<"
...
%.o : $(MATLAB_ROOT)/simulink/src/%.cpp
	$(CC) -c $(MEX_FLAGS) $(INCLUDES) "$<"
%.o : /Users/carlosxavierroserochandi/Documents/truetime-2.0-beta10.1/kernel/%.cpp
	$(CC) -c $(MEX_FLAGS) $(INCLUDES) "$<"
